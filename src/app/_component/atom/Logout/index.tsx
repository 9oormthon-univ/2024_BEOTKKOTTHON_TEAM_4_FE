  ...
  return (
    <>
      ...
      <ModalContainer>
        ...
        <ButtonSection>
          <Button label="취소" variant={'Disabled'} size={'modal'} onClick={handleReset} />
          <Button label="로그아웃" variant={localSelectedOptions.length > 0 ? 'Primary' : 'Secondary'} size={'modal'} onClick={handleConfirm} />
        </ButtonSection>
      </ModalContainer>
    </>
  );
