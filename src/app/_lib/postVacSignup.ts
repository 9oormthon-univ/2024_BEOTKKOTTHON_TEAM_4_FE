...
import {LocalStorage, mapTelecom, parseIdentity, SecureLocalStorage} from '@/hooks/useUtil';

export async function postVacSignup(userData) {
  const vaccinationInfo =  JSON.parse(SecureLocalStorage.getItem('vaccineList');)
