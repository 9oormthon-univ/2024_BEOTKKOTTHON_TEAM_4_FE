    ...
    qaList: [
      {
        ...
        ans:'A형간염은 분변-경구 경로로 전파되며, 대부분 사람에서 사람으로 직접적으로 전파되거나 분변에 오염된 물이나 음식물을 섭취함으로써 간접적으로 전파되기도 합니다.'
      },
      {
        id: 2,
...
// 국가 예방 접종에 대한 데이터
export const nationalDiseaseList = [
  // 국가 예방 접종 질병 데이터
];
...
// 섹션에 따른 질병 리스트를 반환하는 함수
export const getDiseaseListForSection = (selectedSection) => {
  switch (selectedSection) {
    case '필수예방접종':
      return essentialDiseaseList;
    case '국가예방접종':
      return nationalDiseaseList;
    case '기타예방접종':
